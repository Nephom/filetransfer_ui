// Working File Transfer UI App
console.log('Working App: Starting...');

// Check dependencies
if (typeof React === 'undefined' || typeof ReactDOM === 'undefined') {
    console.error('Working App: React dependencies missing');
    ...
    console.log('Working App: Dependencies OK');
    ...
    // Render the app
    try {
        console.log('Working App: Rendering...');
        ReactDOM.render(React.createElement(App), document.getElementById('root'));
        console.log('Working App: Rendered successfully!');
    } catch (error) {
        console.error('Working App: Render failed:', error);
    }
}
