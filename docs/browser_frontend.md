...
| P61 | E01-E08 | src/frontend/checks/browser.e2e.mjs | Complete | Browser E2E passes with maximize/minimize/restore, card-style dock, restore tip, wrapping, responsive, and Account Panel regressions |
